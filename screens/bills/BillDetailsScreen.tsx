...
export default function BillDetailsScreen() {
  ...
  const handlePrintToBluetooth = async () => {
    ...
    try {
      ...
      console.log('Bluetooth is ready, checking for primary printer');
      
      // Try primary printer first
      const primaryResult = await printBillWithPrimaryPrinter(bill);
      
      if (primaryResult.success) {
        console.log('Printed successfully with primary printer');
        Alert.alert('Success', primaryResult.message);
      } else {
        console.log('Primary printer not available or failed, showing printer selection');
        // Show printer selection modal as fallback
